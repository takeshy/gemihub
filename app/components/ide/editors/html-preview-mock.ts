...
export function buildMockGemihubScript(mockData: Record<string, string>): string {
  ...
  return [
    ...
    "auth:{",
    "me:function(t){var f=_m['web/__gemihub/auth/me.json'];if(!f)return Promise.resolve(null);try{var d=JSON.parse(f),td=d[t];if(!td)return Promise.resolve(null);td.type=t;return Promise.resolve(td);}catch(e){return Promise.resolve(null);}},",
