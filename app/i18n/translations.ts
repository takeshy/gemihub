...
export interface TranslationStrings {
  ...
  "settings.sync.migrationTokenPremiumNotice": string;
  "settings.sync.migrationTokenPremiumRequired": string;
...
const en: TranslationStrings = {
  ...
  "header.quickTimeline": "Write to Timeline",
  ...
  "settings.sync.migrationTokenPremiumNotice": "Available on My Drive to Lite, Pro, and Business subscribers. Belonging to an organization does not include it — syncing your own Drive needs your own subscription.",
  "settings.sync.migrationTokenPremiumRequired": "Your own Lite, Pro, or Business subscription is required to generate external sync tokens.",
  ...
  "trash.softDeleteConfirm": "Queue \"{name}\" for trash? It will be moved on the next Push.",
  "trash.softDeleteFolderConfirm": "Queue all {count} file(s) in folder \"{name}\" for trash? They will be moved on the next Push.",
  "trash.bulkDeleteConfirm": "Queue {count} file(s) for trash? They will be moved on the next Push.",
  ...
  "conflict.backupNote": "The overwritten version is kept locally in this browser.",
  ...
  "settings.general.enableVertexAiDescription": "Run chat on Google Vertex AI with a prepaid balance. No Gemini API key needed. Purchase credits below — ¥1,500 ($9 credited) per unit, no expiry.",
...
const ja: TranslationStrings = {
  ...
  "header.quickTimeline": "タイムラインにさっと書く",
  ...
  "settings.sync.migrationTokenPremiumNotice": "マイドライブで、Lite・Pro・Businessいずれかを契約している方が利用できます。組織に所属しているだけでは対象外で、自分のドライブを同期するにはご自身の契約が必要です。",
  "settings.sync.migrationTokenPremiumRequired": "外部同期トークンの生成には、ご自身の Lite・Pro・Business いずれかの契約が必要です。",
  ...
  "trash.softDeleteConfirm": "「{name}」を削除予約しますか？次回のPushでゴミ箱に移動します。",
  "trash.softDeleteFolderConfirm": "フォルダ「{name}」内の{count}件を削除予約しますか？次回のPushでゴミ箱に移動します。",
  "trash.bulkDeleteConfirm": "{count}件を削除予約しますか？次回のPushでゴミ箱に移動します。",
  ...
  "conflict.backupNote": "上書きされたバージョンは、このブラウザ内にローカル保存されます。",
  ...
  "settings.general.enableVertexAiDescription": "チャットをGoogle Vertex AIで実行します（プリペイド残高）。Gemini APIキーは不要です。下記からクレジットを購入 — ¥1,500（$9分クレジット）単位、有効期限なし。",
