// Obsidian Bases compatible implementation — core types.
// Profile: OBX-2026-06
...
export type HostPropertyType = "date" | "datetime" | "text" | "number" | "checkbox" | "list" | "multitext";
...
export interface QueryResult {
  ...
  getSummaryValue(entries: BaseEntry[], property: string, summary: string): Value;
}
