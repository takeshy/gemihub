// Drive-mount IndexedDB cache implementation ("gemihub-cache" DB, fileId
// identity). Import through ./indexeddb-cache — the mount-aware dispatcher —
// unless the caller is Drive-specific by design.
...
export interface CachedFile {
  ...
  /** Mount-cache fields (unused on the Drive mount, where they stay undefined). */
  contentType?: string;
  revision?: string;
  dirty?: boolean;
}
