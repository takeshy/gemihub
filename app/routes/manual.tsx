...
const CHAPTERS: ChapterDef[] = [
  ...
  { slug: "dashboard", num: 3, titleEn: "Dashboards", titleJa: "ダッシュボード", descEn: "Build a home screen with widgets: notes, folders, kanban boards, workflows, Bases, and web embeds.", descJa: "ノート、フォルダ、カンバン、ワークフロー、Base、Web埋め込みでホーム画面を作成。", component: DashboardChapter },
