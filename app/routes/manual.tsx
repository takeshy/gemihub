...
const CHAPTERS: ChapterDef[] = [
  ...
  { slug: "premium", num: 17, titleEn: "Premium Plan", titleJa: "プレミアムプラン", descEn: "Lite and Business plans: Interactions API, Gmail, PDF, Sheets, hosting, scheduling, and more.", descJa: "LiteとBusinessプラン：Interactions API、Gmail、PDF、Sheets、ホスティング、スケジュール実行など。", component: PremiumChapter },
