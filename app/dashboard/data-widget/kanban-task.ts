export const TASK_DETAILS_START = "<!-- gemihub:task-details:start -->";
export const TASK_DETAILS_END = "<!-- gemihub:task-details:end -->";
...
export function isCompletionColumn(value: string, label: string): boolean {
